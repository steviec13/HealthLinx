...
<table class="bodyText" align="center" border="0" cellpadding="0" cellspacing="0" width="364">
                                            <tbody><tr>
                                                <td>
                                                    <div align="left">
													<span class="navHeadlineOrg"><strong>Complete this registration form to get started!</strong></span><br />Fields marked with an asterisk (<span class="style2">*</span>) are required.<br />
<form name="sitelokregisteruser" action="register.php" method="POST" enctype="multipart/form-data">
<?php registeruser("JOBS","0","../critical_care/opportunities2.php?username=!!!username!!!&password=!!!passwordhash!!!","newuser.htm","newuseradmin.htm","Yes","YYYYYYYYYYYYYYYYY"); ?>
  ...
  <table class="bodyText" bgcolor="#ffffff" border="0" cellpadding="2" cellspacing="1">
    <tbody>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> First Name:</td>
        <td align="left" valign="baseline" width="362"><input type="text" name="custom1" maxlength="50" size="30" value="<?php echo $custom1; ?>"></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Last Name:</td>
        <td align="left" valign="baseline" width="362"><input type="text" name="name" maxlength="50" size="30" value="<?php echo $name; ?>">
          <sup><font color="#ff0000">*</font></sup></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Contact Phone:<br>
          <sup>Please indicate<br>Work (W) or Home (H)</sup></td>
        <td align="left" valign="center"><input type="text" name="custom2" maxlength="50" size="30" value="<?php echo $custom2; ?>"></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Email:</td>
        <td align="left" valign="baseline" width="362"><input type="text" name="email" maxlength="50" size="30">
          <sup><font color="#ff0000">*</font></sup></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Verify Email:</td>
        <td align="left" valign="baseline" width="362"><input type="text" name="verifyemail" maxlength="50" size="30">
          <sup><font color="#ff0000">*</font></sup></td>
      </tr> 
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Create a Password:<br></td>
        <td align="left" valign="baseline" width="362"><input type="password" name="password" maxlength="50" size="30">
          <sup><font color="#ff0000">*</font></sup></td>
      </tr>
	  <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Verify Password:</td>
        <td align="left" valign="baseline" width="362"><input type="password" name="verifypassword" maxlength="50" size="30">
          <sup><font color="#ff0000">*</font></sup></td>
      </tr>
	  <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> City:</td>
        <td align="left" valign="baseline" width="362"><input type="text" name="custom3" maxlength="50" size="30" value="<?php echo $custom3; ?>"></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> State:</td>
        <td align="left" valign="baseline" width="362"><select name="custom4">
      ...
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Current Position:</td>
        <td align="left" valign="baseline" width="362"><select name="custom5">
      ...
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Current Field:</td>
        <td align="left" valign="baseline" width="362"><select name="custom6">
            <option>Select:</option>
      ...
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Other Areas of Interest (desired positions/fields):<br><br></td>
        <td align="left" valign="baseline" width="362"><textarea rows="3" name="custom7" cols="25" value="<?php echo $custom7; ?>"></textarea></td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Desired Location(s):</td>
        <td align="left" valign="baseline" width="362"><select name="custom9">
      ...
      <tr>
        ...
        <td align="left" valign="top" width="362"><select name="custom8">
      ...
      <tr>
        <td align="left" valign="top" width="180"></td>
        <td align="left" valign="baseline"><select name="custom10">
      ...
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"> Referred by:</td>
        <td align="left" valign="baseline" width="362"><input type="text" name="custom11" maxlength="50" size="30" value="<?php echo $custom11; ?>">
        </td>
      </tr>
      <tr>
        <td align="left" bgcolor="#eeedeb" valign="top" width="180"><p><strong>Upload your resume here:</strong></p>
		</td>
		
        <td align="left"><input type="file" name="custom13">
        </tr>
		<tr>
		</tr>
		<tr>
		</td>
		        <td align="left" bgcolor="#eeedeb" valign="top" width="180"><p>Additional Comments:</p>
          
          <p> To submit comments, simply<br>
            type in the box to the right. <br>
          </p></td>
        <td align="left"><textarea name="custom12" maxlength="255" size="30" rows="10" cols="25" value="<?php echo $custom12; ?>"></textarea>
          <br>
        </td>
      </tr>
      <tr>
