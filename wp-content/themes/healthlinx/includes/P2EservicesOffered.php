<div class="lePageServices">
    ...
    <div class="quarterWidth">
        ...
        <?php query_posts( array( 'category__and' => array(1,15), 'posts_per_page' => 2, 'orderby' => 'date', 'order' => 'DESC' ) ); ?>		
        <div>
        ...
        <?php query_posts( array( 'category__and' => array(11,15), 'posts_per_page' => 2, 'orderby' => 'date', 'order' => 'DESC' ) ); ?>		
        <div>
            <?php while (have_posts()) : the_post(); ?>
                <div class="individualPost">
        ...
        <?php query_posts( array( 'category__and' => array(12,15), 'posts_per_page' => 2, 'orderby' => 'date', 'order' => 'DESC' ) ); ?>		
        <div>
            <?php while (have_posts()) : the_post(); ?>
                <div class="individualPost">
                    <img src="http://solutions.healthlinx.com/cdnr/34/acton/attachment/4436/f-01da/1/-/-/-/-/Briefcase%20Icon.png" />
        ...
        <?php query_posts( array( 'category__and' => array(10,15), 'posts_per_page' => 2, 'orderby' => 'date', 'order' => 'DESC' ) ); ?>		
        <div>
            <?php while (have_posts()) : the_post(); ?>
                <div class="individualPost">
                    <img src="http://solutions.healthlinx.com/cdnr/34/acton/attachment/4436/f-01da/1/-/-/-/-/Briefcase%20Icon.png" />
